...
const BASE_SYSTEM_PROMPT = [
  ...
  "If a memory.recall_decision section is present:",
  "- decision=answer_from_memory means recalled memory likely covers the user's follow-up. Answer from memory first and avoid tool calls unless memory is incomplete, conflicting, or the user explicitly asks for fresh/current data.",
