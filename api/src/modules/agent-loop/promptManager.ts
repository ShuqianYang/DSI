...
export const DEFAULT_PROMPT_COMPONENT_VERSIONS = {
  ...
  oilSpillMockRules: "oil-spill-mock-rules-v3",
  fireInvestigationRules: "fire-investigation-rules-v1",
...
const BASE_SYSTEM_PROMPT = [
  ...
  "When and only when the user input starts with the exact demo command '/demo:oil-spill-mock':",
  ...
  "7. If the user asks about oil spills, oil film, oil pollution, illegal discharge, pollution origin tracing, AIS suspect matching, or suspected responsible vessels without the '/demo:oil-spill-mock' prefix, do not use this skill or its mock tools; use the regular GIS, disaster, weather, or AIS tools instead.",
  "",
  "# Fire Investigation Mock Routing Rules",
  "When and only when the user input starts with the exact demo command '/demo:fire-investigation':",
  ...
  "4. Call FireSatelliteMock to overlay the post-fire image and burn mask.",
  ...
  "7. Keep multi-step GIS replay by calling the tools in the skill order; do not collapse the workflow into one answer.",
  "8. For this mock scenario, do not use real SatelliteImageSearch, DisasterQuery, weather services, or live remote-sensing data unless the user explicitly asks to leave the mock demo.",
  "9. If the user asks about fire, wildfire, burned area, or fire investigation without the '/demo:fire-investigation' prefix, do not use this skill or its mock tools; use the regular disaster-satellite-query skill or available live tools instead.",
  "",
