...
export const DEFAULT_PROMPT_COMPONENT_VERSIONS = {
  ...
  fireInvestigationRules: "fire-investigation-rules-v2",
...
const BASE_SYSTEM_PROMPT = [
  ...
  "4. Call FireSatelliteMock to overlay the post-fire image.",
  ...
  "9. If the user asks about fire, wildfire, burned area, or fire investigation without the '/演示:火情研判' prefix, do not use this skill or its mock tools; use the regular disaster-satellite-query skill or available live tools instead.",
  "",
